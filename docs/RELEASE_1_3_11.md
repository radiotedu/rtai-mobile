...
Validation before native build: 123 Jest suites / 567 tests passed; TypeScript and ESLint error checks; Android static audit; release version/workflow contracts. Native APK and phone/tablet runtime evidence are produced by GitHub Actions from the release commit. This does not substitute for physical two-device discovery, iOS device testing, or a legal compliance audit.
