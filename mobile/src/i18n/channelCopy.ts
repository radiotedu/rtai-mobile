...
const CHANNEL_COPY: Record<AppLanguage, Record<string, ChannelCopy>> = {
  en: {
    ...
    spark: {name: 'RadioTEDU Voting', description: 'Interactive voting radio'},
  ...
  tr: {
    ...
    spark: {name: 'RadioTEDU Voting', description: 'Etkileşimli oylama radyosu'},
