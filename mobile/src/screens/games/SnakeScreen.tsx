...
const styles = StyleSheet.create({
  ...
  board: {alignSelf: 'center', padding: 6, borderRadius: 18, overflow: 'hidden', borderWidth: 1, borderColor: 'rgba(72,224,138,0.48)', backgroundColor: '#101F1C', shadowColor: '#48E08A', shadowOpacity: 0.2, shadowRadius: 18, elevation: 8},
  row: {flexDirection: 'row'},
  cell: {width: 22, height: 22, margin: 0.5, borderRadius: 5, backgroundColor: '#142722', borderWidth: 0.5, borderColor: '#1B2A21', alignItems: 'center', justifyContent: 'center'},
  snakeCell: {backgroundColor: '#32C99B', borderColor: '#67F0A4'},
  ...
  controlButton: {width: 52, height: 52, borderRadius: 14, alignItems: 'center', justifyContent: 'center', backgroundColor: '#20332E', borderWidth: 1, borderColor: 'rgba(72,224,138,0.28)'},
  pauseButton: {width: 52, height: 52, borderRadius: 4, alignItems: 'center', justifyContent: 'center', backgroundColor: '#32C99B', shadowColor: '#48E08A', shadowOpacity: 0.32, shadowRadius: 10, elevation: 6},
