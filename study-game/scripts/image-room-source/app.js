...
const WALKABLE_TILES = {
  ...
  'lower-right-aisle': {x: 75.35885167464114, y: 81.19022316684379, neighbors: ['bottom-right-aisle', 'seat-middle-right-stand']},
  ...
  'upper-right-aisle': {x: 67.70334928229666, y: 46.3336875664187, neighbors: ['upper-center-aisle', 'middle-right-aisle', 'lounge', 'seat-front-right-stand']},
  ...
  'seat-front-desk-stand': {x: 52.87081339712919, y: 49.73432518597237, neighbors: ['upper-center-aisle']},
  'seat-front-right-stand': {x: 67.22, y: 46.33, neighbors: ['upper-right-aisle', 'upper-center-aisle']},
  ...
  'seat-lamp-right-stand': {x: 47.12918660287082, y: 61.6365568544102, neighbors: ['middle-right-aisle']},
